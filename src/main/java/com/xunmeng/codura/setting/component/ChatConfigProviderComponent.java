...
public class ChatConfigProviderComponent extends JPanel {
    private CodeState codeState;
    public ChatConfigProviderComponent(CodeState codeState){
        super();
    ...
    private JComponent createCompletionConfigProvider(){
        JPanel panel = new ProviderComponent(codeState.getChatConfigProvider()).getPanel();
        return panel;
    }
